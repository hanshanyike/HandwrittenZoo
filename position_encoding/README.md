...
|------|------|----------|----------|----------|
| [Sinusoidal](sinusoidal.md) | 绝对位置编码 | 正弦/余弦函数生成确定性位置向量 | Transformer (原版) | 弱 |
| [Learnable](learnable.md) | 绝对位置编码 | 每个位置是可训练参数 | BERT, GPT-2, ViT | 无 |
| [RoPE](rope.md) | 相对位置编码 | 旋转矩阵变换 Q/K，内积仅依赖相对距离 | LLaMA, Mistral, Qwen | 强（配合 NTK） |
| [ALiBi](alibi.md) | 相对位置编码 | 在 attention score 上添加距离相关的线性负偏置 | MPT, BLOOM, Baichuan | 很强 |
